...
namespace acgsky
{
    ...
    /// </summary>
    public sealed partial class DMZXPage : Page
    {
        ...
        private string Uri0 = @"http://acg.gamersky.com/news/";
        private string Uri1 = @"http://acg.gamersky.com/news/animation/";
        private string Uri2 = @"http://acg.gamersky.com/news/comic/";
        private string Uri3 = @"http://acg.gamersky.com/news/seiyuu/";
            ...
            switch (((Pivot)sender).SelectedIndex)
            {
                case 0:
                        ...
                        if (ST0 == false)
                        {
                            try
                            {
                                Text0 = await webClient.GetStringAsync(new Uri(@"http://acg.gamersky.com/news/"));
                ...
                case 1:
                    ...
                    if (ST1 == false)
                    {
                        try
                        {
                            Text1 = await webClient.GetStringAsync(new Uri(@"http://acg.gamersky.com/news/animation/"));
                ...
                case 2:
                    ...
                    if (ST2 == false)
                    {
                        try
                        {
                            Text2 = await webClient.GetStringAsync(new Uri(@"http://acg.gamersky.com/news/comic/"));
                            加载(Text2.Substring(Text0.IndexOf("<ul class=\"Ptxt block\">"), Text2.IndexOf("<div class=\"Page\">") - Text2.IndexOf("<ul class=\"Ptxt block\">")));
                ...
                case 3:
                    ...
                    if (ST3 == false)
                    {
                        try
                        {
                            Text3 = await webClient.GetStringAsync(new Uri(@"http://acg.gamersky.com/news/seiyuu/"));
                        加载(Text3.Substring(Text0.IndexOf("<ul class=\"Ptxt block\">"), Text3.IndexOf("<div class=\"Page\">") - Text3.IndexOf("<ul class=\"Ptxt block\">")));
        ...
        private async void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            //if (Text.Contains("下一页</a></span>"))
            //{
            //    ((Button)sender).IsEnabled = true;
            //    string s2 = "class=\"p2\" href=\"";
            //    string e2 = "\">下一页";
            //    //Match M2 = new Regex("(?<=(" + s2 + "))[.\\s\\S]*?(?=(" + e2 + "))", RegexOptions.Multiline | RegexOptions.Singleline).Match(Text);
            //    Match M2 = new Regex("(?<=(" + s2 + "))[.\\s\\S]*?(?=(" + e2 + "))", RegexOptions.Multiline | RegexOptions.Singleline).Match(Text.Substring(Text.LastIndexOf("\">下一页")-80,100));
            //    //if (M2.Count == 1){Text2 = M2[0].Value;}else { Text2 = M2[1].Value; }

            //    PT.Title = M2.Value;
            //    switch (PT.SelectedIndex)
            //    {
            //        case 0: Uri0 = M2.Value; break;
            //        case 1: Uri1 = M2.Value; break;
            //        case 2: Uri2 = M2.Value; break;
            //        case 3: Uri3 = M2.Value; break;
            //    }
            //}
            //else
            //{
        ...
        //private bool iscw0 = false;
        //private bool iscw1 = false;
        //private bool iscw2 = false;
        //private bool iscw3 = false;
        private void Button_Loaded(object sender, RoutedEventArgs e)
        {
            switch (PT.SelectedIndex)
            {
                case 0: B0 = (Button)sender;
                    break;
                case 1: B1 = (Button)sender;
                    break;
                case 2: B2 = (Button)sender;
                    break;
                case 3: B3 = (Button)sender;
                    break;
            }
        }
